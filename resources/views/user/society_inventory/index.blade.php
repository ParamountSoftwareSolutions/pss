                                        ...
                                        @forelse($society_inventory as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('society.block.society_inventory.show', ['RolePrefix' => RolePrefix(), 'society' =>
                                                    $data->society_id, 'block' =>
                                                    $data->block_id, $data->id]) }}"
                                                       class="btn btn-primary px-1 py-0" title="Edit">
    ...
    <script>
        $(document).ready(function () {
            $("body").on("click", ".change_status", function() {
                ...
                $('#form_id').val(id);
                $('#statusForm').attr('action', "{{route('inventory.change_status', ['RolePrefix' => RolePrefix(),'project_id'=>2])}}");
            ...
            $('#statusForm').submit(function (e) {
                ...
                $.ajax({
                    url: "{{route('inventory.change_status', ['RolePrefix' => RolePrefix(),'project_id'=>2])}}",
                    type: "POST",
                    data: formData,
