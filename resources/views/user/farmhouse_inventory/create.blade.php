            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <form method="post" action="{{ route('farmhouse.block.inventory.store', ['RolePrefix' => RolePrefix(),'farmhouse'=>$farmhouse_id,'block'=>$block_id]) }}" enctype="multipart/form-data">
                            <div class="card">
                                @csrf
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="name" readonly style="cursor: not-allowed" value="{{ $farmhouse->project->name }}">
                                            @error('name')
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="block_name" readonly style="cursor: not-allowed" value="{{ $block->name }}">
                                            @error('name')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('select[name="premium_id"]').change(function () {
                ...
                var project_type_id = {{$farmhouse->project->type_id}};
                $.ajax({
