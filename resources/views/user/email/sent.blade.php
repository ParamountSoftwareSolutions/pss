                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>Email History</h4>
                            <a href="{{ route('email.compose',RolePrefix()) }}" class="btn btn-primary"
                               style="margin-left: auto; display: block;">Compose</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('email.detail',['RolePrefix'=>RolePrefix(),'id'=>$data->id]) }}">{{ $data->to }}</a></td>
                                        <td>{{ $data->subject }}</td>
                                        <td>{{ $data->date }}</td>
                                        <td>
                                            <button data-url="{{ route('email.forward',['RolePrefix'=>RolePrefix(),'id'=>$data->id]) }}"
                                               class="btn btn-primary px-1 py-0 forward" title="Forward">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Forward To</h5>
