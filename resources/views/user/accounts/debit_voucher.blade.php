                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <form method="POST" action="{{route('accounts.create_debit_voucher')}}">
                                        @csrf
