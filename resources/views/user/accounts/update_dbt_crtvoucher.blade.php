                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <form method="POST" action="{{route('accounts.update_debit_voucher')}}">
                                    @csrf   
                                    <div class="form-group row">
                                            <label for="vo_no" class="col-sm-2 col-form-label"><?php echo display('voucher_no') ?></label>
                                            <div class="col-sm-4">
                                                <input type="text" name="txtVNo" id="txtVNo" value="<?php echo $data['credit_info']->VNo ?>" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select name="cmbDebit" id="cmbDebit" class="form-control">
                                                    ...
                                                    <?php foreach ($data['crcc'] as $cracc) { ?>
                                                        <option value="<?php echo $cracc->HeadCode; ?>" <?php if ($data['credit_info']->COAID == $cracc->HeadCode) {
                                                                                                            echo 'selected';
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo $data['credit_info']->VDate; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="txtRemarks" class="col-sm-2 col-form-label"><?php echo display('remark') ?></label>
                                            <div class="col-sm-4">
                                                <textarea name="txtRemarks" id="txtRemarks" class="form-control"><?php echo $data['credit_info']->Narration; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="table-responsive update_dbt_crtvoucher_mr_tp">
                                            <table class="table table-bordered table-hover" id="debtAccVoucher">
                                                ...
                                                <tbody id="debitvoucher">
                                                    <?php $sl = 1;
                                                    foreach ($data['dbvoucher_info'] as $debitvoucher) { ?>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <input type="text" id="grandTotal" class="form-control text-right " name="grand_total" value="<?php echo $data['credit_info']->Credit; ?>" readonly="readonly" />
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                            </table>
