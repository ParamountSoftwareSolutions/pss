                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <form method="POST" action="{{route('accounts.update_journal_voucher')}}">
                                    @csrf
                                        <div class="form-group row">
                                            <label for="vo_no" class="col-sm-2 col-form-label"><?php echo display('voucher_no') ?></label>
                                            <div class="col-sm-4">
                                                <div class="col-sm-4">
                                                    <input type="text" name="txtVNo" id="txtVNo" value="<?php echo $data['journal_info'][0]->VNo; ?>" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo $data['journal_info'][0]->VDate; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="txtRemarks" class="col-sm-2 col-form-label"> <?php echo display('remark') ?></label>
                                            <div class="col-sm-4">
                                                <textarea name="txtRemarks" id="txtRemarks" class="form-control"><?php echo $data['journal_info'][0]->Narration ?></textarea>
                                            </div>
                                        </div>
                                        <div class="table-responsive update_journal_voucher_mr_top">
                                            <table class="table table-bordered table-hover" id="debtAccVoucher">
                                                ...
                                                <tbody id="debitvoucher">
                                                    ...
                                                    $sl = 1;
                                                    $dbt = $cdt = 0;
                                                    foreach ($data['journal_info'] as $single) {
                                                    ?>
                                                        <tr>
