                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <div class="profile-info-left">
                                                                ...
                                                                <div class="staff-id">Employee ID : {{ $user[0]->user_id }}
                                                                </div>
                                                                <div class="small doj text-muted">Date of Join :
                                                                    {{ $user[0]->join_date }}</div>
                                                        ...
                                                        <div class="col-md-7">
                                                            <ul class="personal-info">
                                                                <li>
                                                                    ...
                                                                    <div class="text"><a
                                                                            href="">{{ $user[0]->phone_number }}</a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="title">Email:</div>
                                                                    <div class="text"><a
                                                                            href="">{{ $user[0]->email }}</a></div>
                                                                </li>
                                                                <li>
                                                                    @if (!empty($users))
                                                                    ...
                                                                    <div class="text">
                                                                        <div class="avatar-box">
                                                                            <div class="avatar avatar-xs">
                                                                                <img src="{{ URL::to('/assets/images/' . $user[0]->avatar) }}"
                                                                                    alt="{{ $user[0]->name }}">
                                                                            </div>
                                                                        </div>
                                                                        <a href="profile.html">
                                ...
                                <div id="emp_profile" class="pro-overview tab-pane fade show active">
                                    <div class="row">
                                            ...
                                            <div class="card profile-box flex-fill">
                                                <div class="card-body">
                                                    <h3 class="card-title">Personal Informations <a href="#"
                                                            class="edit-icon" data-toggle="modal"
                                                    ...
                                                    <ul class="personal-info">
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="text"><a href="">{{ $users->tel }}</a>
                                                            </div>
                                                        </li>
                                                        <li>
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <div class="card profile-box flex-fill">
                                                <div class="card-body">
                                                    <h3 class="card-title">Emergency Contact <a href="#"
                                                            class="edit-icon" data-toggle="modal"
                                                            data-target="#emergency_contact_modal"><i
                                                                class="fa fa-pencil"></i></a></h3>
                                            ...
                                            <div class="card profile-box flex-fill">
                                                <div class="card-body">
                                                    <h3 class="card-title">Family Informations <a href="#"
                                                            class="edit-icon" data-toggle="modal"
                                                            data-target="#family_info_modal"><i
                                                                class="fa fa-pencil"></i></a></h3>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <div class="dropdown dropdown-action">
                                                                            <a aria-expanded="false"
                                                                                ...
                                                                                href="#"><i
                                                                                    class="material-icons">Actions</i></a>
                                            ...
                                            <div class="card profile-box flex-fill">
                                                <div class="card-body">
                                                    <h3 class="card-title">Education Informations <a href="#"
                                                            class="edit-icon" data-toggle="modal"
                                                            data-target="#education_info"><i class="fa fa-pencil"></i></a>
                                                    </h3>
                                                        ...
                                                        <ul class="experience-list">
                                                            <li>
                                                                ...
                                                                <div class="experience-content">
                                                                    <div class="timeline-content">
                                                                        <a href="#/" class="name">International
                                                                            College of Arts and Science (UG)</a>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="experience-content">
                                                                    <div class="timeline-content">
                                                                        <a href="#/" class="name">International
                                                                            College of Arts and Science (PG)</a>
                                                ...
                                                <div class="card-body">
                                                    <div class="dropdown profile-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a data-target="#delete_project" data-toggle="modal"
                                                                href="#" class="dropdown-item"><i
                                                ...
                                                <div class="col-md-12">
                                                    <div class="profile-img-wrap edit-img">
                                                        ...
                                                        <div class="fileupload btn">
                                                            ...
                                                            <input class="upload" type="file" id="image"
                                                                name="images">
                                                            @if (!empty($users))
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control @error('tel') is-invalid @enderror"
                                                            type="text" name="tel" value="{{ $users->tel }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
