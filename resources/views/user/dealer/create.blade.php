                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control" name="actual_amount" required>
                                            @error('actual_amount')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control" name="received">
                                            @error('received')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control" readonly name="pending">
                                            @error('pending')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
