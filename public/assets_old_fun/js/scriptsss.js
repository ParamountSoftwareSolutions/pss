...
$(function () {
  ...
  $(".choose-theme li").on("click", function () {
    $(".main-navbar").removeClass("gradient-navbar");
    var bodytag = $("body"),
      selectedTheme = $(this),
  ...
  $(".sidebar-color input:radio").change(function () {
    if ($(this).val() == "1") {
      $(".main-sidebar").removeClass("darkcolor-sidebar");
      $(".main-sidebar").removeClass("gradient-sidebar");
      $("li.dropdown a.nav-link span").removeClass("text-light");
      $("li.dropdown a.nav-link i").removeClass("fa-color");
      $("li.dropdown a.nav-link i").addClass("fa-dark");
      $("li.dropdown a.nav-link span").addClass("text-dark");
	  $("li.dropdown ul.dropdown-menu li a").addClass("text-dark");
	  $("li.dropdown ul.dropdown-menu li a").removeClass("text-light");
      $(".main-sidebar").addClass("lightcolor-sidebar");
	  $("li.dropdown a").addClass("darko");
    } 
    else if(($(this).val() == "2")) {
      $(".main-sidebar").removeClass("lightcolor-sidebar");
      $("li.dropdown a.nav-link i").removeClass("fa-dark");
      $("li.dropdown a.nav-link span").removeClass("text-dark");
      $(".main-sidebar").removeClass("gradient-sidebar");
	  $("li.dropdown ul.dropdown-menu li a").removeClass("text-dark");
	  $("li.dropdown ul.dropdown-menu li a").addClass("text-light");
      $(".main-sidebar").addClass("darkcolor-sidebar");
	  $("li.dropdown a").removeClass("darko");
    } 
    else  {
      $(".main-sidebar").removeClass("lightcolor-sidebar");
      $("li.dropdown a.nav-link i").removeClass("fa-dark");
      $("li.dropdown a.nav-link span").removeClass("text-dark");
      $("body").removeClass("darkcolor-sidebar");
	  $("li.dropdown ul.dropdown-menu li a").removeClass("text-dark");
	  $("li.dropdown ul.dropdown-menu li a").addClass("text-light");
      $(".main-sidebar").addClass("gradient-sidebar");
      $(".main-navbar").addClass("gradient-navbar");
      $("li.dropdown a").removeClass("darko");
    }
  });
